...
window.onload = () => {
    ...
    let formCarga = document.querySelector("#formCarga");
        ...
        var confirmacion = confirm("Estas seguro que deseas borrar todo? ")    
            if(!confirmacion){
        ...
        formCarga.onsubmit = function(event){
            ...
            if(!adjuntarimagen.value){
                formCarga.querySelector("#erroradjuntarimagen").innerText= "Debes seleccionar una imagen";
